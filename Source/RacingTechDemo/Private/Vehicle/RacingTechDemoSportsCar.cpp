...
ARacingTechDemoSportsCar::ARacingTechDemoSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingTechDemoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingTechDemoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingTechDemoSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingTechDemoSportsWheelRear::StaticClass();
